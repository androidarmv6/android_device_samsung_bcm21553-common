...
#ifndef BRCM_OMX_PLUGIN_H_

#define BRCM_OMX_PLUGIN_H_

#include <media/hardware/OMXPluginBase.h>

namespace android {

struct BRCM_OMXPlugin : public OMXPluginBase {
    BRCM_OMXPlugin();
    virtual ~BRCM_OMXPlugin();
...
private:
    ...
    BRCM_OMXPlugin(const BRCM_OMXPlugin &);
    BRCM_OMXPlugin &operator=(const BRCM_OMXPlugin &);
};

}  // namespace android

#endif  // BRCM_OMX_PLUGIN_H_
